...
export class AppComponent {
  ...
  item:string;
  printData1(){
    this.res.push(this.item);
    this.item='';
  }
  deleteItem(index){
    this.res.splice(index,1)
  }*/
 // Uobj:User={username:"",dob:"",email:""};
